...
import { StyleSheet, Text, View , ImageBackground ,  Keyboard,ScrollView,SafeAreaView, Image , TextInput ,TouchableOpacity} from 'react-native';
  ...
  return (
    ...
    <View  >
       ...
       <TextInput 
        ...
        />
            {error && !longitude &&<Text style={{color:'red' , alignContent:'center' , alignSelf:'center',fontSize:12 , fontWeight:'bold'}} > champ obligatoire *</Text>}
    </View>
    <View  >
     ...
     <TextInput 
      ...
      />
          {error && !latitude &&<Text style={{color:'red' , alignContent:'center' , alignSelf:'center',fontSize:12 ,fontWeight:'bold'}} > champ obligatoire *</Text>}
  </View>
      <View  >
